...
model_urls = {
    ...
    'drn-d-105': 'file:///notebooks/DeepUSPS/Pretrained_Models/drn_pretraining/' + '/drn_d_105_cityscapes.pth'
}
...
def drn_d_22(pretrained=False, **kwargs):
    ...
    if pretrained:
        #model.load_state_dict(torch.load("/notebooks/DeepUSPS/Pretrained_Models/drn_pretraining/drn_d_22_cityscapes.pth"),strict=False)
        model.load_state_dict(torch.load("/notebooks/DeepUSPS/Doc/Phase_II_Fusion/checkpoint_200.pth.tar"),strict=False)
    return model
...
def drn_d_105(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load("/notebooks/DeepUSPS/Pretrained_Models/drn_pretraining/drn_d_105_cityscapes.pth"),strict=False)
        #model.load_state_dict(torch.load("drn_d_105_cityscapes.pth"))
