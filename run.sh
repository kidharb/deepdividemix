#!/bin/bash
python DeepUSPS.py train -r /notebooks/deepdividemix -s 432 --arch drn_d_22 --iter_size 1 --batch-size 20 --pretrained /notebooks/deepdividemix/Pretrained_Models/drn_pretraining/drn_d_22_cityscapes.pth
